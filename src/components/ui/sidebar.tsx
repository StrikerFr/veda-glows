      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex h-dvh min-h-screen w-full has-[[data-variant=inset]]:bg-sidebar",
              className,
            )}
            ref={ref}
            {...props}
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-dvh min-h-screen w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
            side === "left"
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-dvh min-h-screen w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
